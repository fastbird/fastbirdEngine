...
#include <Engine/ParticleEnum.h>
#include <CommonLib/CircularBuffer.h>

namespace fastbird
{
	class ParticleRenderObject;
	...
	public:
		...
		virtual void Active(bool a, bool pending = false);
		virtual void Stop();
		void ParticleEmitter::ProcessDeleteOnStop(bool stopping, bool force = false);
		...
		struct ParticleTemplate
		{
			...
			ParticleRenderObject* mParticleRenderObject;
		};
